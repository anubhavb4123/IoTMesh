...
export const SensorCard = ({
  ...
  return (
    <Card className={cn(
      ...
      "transition-all duration-300 hover:scale-[1.03] hover:border-border/70 hover:-translate-y-1",
      statusGlow[status]
    )}>
      {/* Left status bar */}
      <div className={cn(
      ...
      <div className="absolute top-4 right-4 z-10">
        <div className={cn(
          "p-2 rounded-xl bg-secondary/50 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110",
          statusColors[status]
        )}>
