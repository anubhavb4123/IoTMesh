...
export default function Dashboard() {
  ...
  // Weather prediction → status & icon
  ...
  const cards = [
    <SensorCard title="Temp (DHT11)" value={d.temp} unit="°C" icon={Thermometer} status={getTempStatus(d.temp)} description="DHT11 sensor" />,
    <SensorCard title="Temp (BMP180)" value={d.tempBMP} unit="°C" icon={Thermometer} status={getTempStatus(d.tempBMP)} description="BMP180 sensor" />,
    <SensorCard title="Avg Temperature" value={avgTemp} unit="°C" icon={Thermometer} status={getTempStatus(avgTemp)} description="DHT11 + BMP180 avg" />,
    ...
    <SensorCard title="Motion" value={d.motion} icon={PersonStanding} status={d.motion === "Detected" ? "warning" : "ok"} description="PIR motion sensor" />,
    ...
    <SensorCard title="Weather" value={weather?.prediction ?? "—"} icon={weatherIcon} status={weatherStatus} description={trendStr} />,
  ];
